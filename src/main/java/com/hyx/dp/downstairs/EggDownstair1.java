 ...
 * 本文采用第一种，如有小伙胖有兴趣可以将第二种写法附加进来。
 * 
 * @author sq
 * @date 2020/05/29
 */
public class EggDownstair1 {
    ...
    public int countMinSetp(int n, int h) {
        ...
        int countNum1 = (int)Math.ceil(Math.sqrt(h));
        while ((Math.pow(countNum1, 2) - countNum1) < (2 * h)) {
            countNum1++;
        }
        return countNum1 - 1;
    }
    ...
    public static void main(String[] args) {
        System.out.println(new EggDownstair1().countMinSetp(2, 100));
    }
